    ...
    <div className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-24">
      <header className="max-w-2xl">
        ...
        <p className="mt-5 text-brown leading-relaxed">
          Each Love You studio is independently run, so you always book with the
          salon nearest you. Choose a city to explore studios, hours and
          booking.
        </p>
      </header>
            ...
            <>
              ...
              <div className="flex flex-1 flex-col p-7">
                ...
                <span className="mt-6 text-[0.7rem] font-medium uppercase tracking-[0.18em] text-gold-dark">
                  {m.comingSoon
                    ? "Opening soon"
                    : `View ${count} ${count === 1 ? "studio" : "studios"} →`}
                </span>
              </div>
            </>
          );
