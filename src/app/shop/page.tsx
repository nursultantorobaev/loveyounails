    ...
    <div className="mx-auto max-w-7xl px-5 py-16 md:px-8 md:py-24">
      ...
      <header className="max-w-2xl">
        ...
        <p className="mt-5 text-brown leading-relaxed">
          Salon-quality nail care, crafted to the same standard as our services.
          Our professional product line is launching soon — here's a first look.
        </p>
        <a
        ...
        {PRODUCTS.map((p) => (
          ...
          >
            ...
            <div className="flex flex-1 flex-col p-6">
              ...
              <h2 className="mt-2 text-2xl text-espresso">{p.name}</h2>
              {p.variant && (
                <p className="text-sm italic text-brown-soft">{p.variant}</p>
              )}
      ...
      <p className="mt-12 text-sm text-brown-soft">
        Prices shown are indicative and subject to change at launch. Online
